error id: file://<WORKSPACE>/app/src/main/java/os_p2/engine/LegacyNativeEngine.java:java/lang/foreign/ValueLayout#
file://<WORKSPACE>/app/src/main/java/os_p2/engine/LegacyNativeEngine.java
empty definition using pc, found symbol in pc: java/lang/foreign/ValueLayout#
    ...
    public Stream<List<String>> scan(VirtualFileSystem vfs, String rootPath) {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            for (int i = 0; i < length; i++) {
                MemorySegment stringPtr = sizedDump.getAtIndex(Value@@Layout.ADDRESS, i);
