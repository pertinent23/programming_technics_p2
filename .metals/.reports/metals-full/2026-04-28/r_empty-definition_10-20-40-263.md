error id: file://<WORKSPACE>/app/src/main/java/os_p2/engine/PureJavaHashEngine.java:java/lang/String#
...
public class PureJavaHashEngine implements DeduplicationEngine {
    ...
    public Stream<List<String>> scan(VirtualFileSystem vfs, String rootPath) {
        ...
        // TODO: Adapter selon les vraies méthodes de ton interface VirtualFileSystem fournie
        // List<String> allFiles = vfs.walkTree(rootPath);
        List<@@String> allFiles = new ArrayList<>(); // Bouchon
