error id: file://<WORKSPACE>/app/src/main/java/os_p2/engine/LegacyNativeEngine.java:_empty_/filededup_h#
file://<WORKSPACE>/app/src/main/java/os_p2/engine/LegacyNativeEngine.java
empty definition using pc, found symbol in pc: _empty_/filededup_h#
...
public class LegacyNativeEngine implements DeduplicationEngine {
    ...
    public Stream<List<String>> scan(VirtualFileSystem vfs, String rootPath) {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment fdState = filededup_@@h.FDInit();
            ...
            List<String> paths = vfs.listContent(rootPath);
