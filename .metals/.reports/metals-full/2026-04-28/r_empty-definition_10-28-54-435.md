error id: file://<WORKSPACE>/app/src/main/java/os_p2/engine/ImageSimilarityEngine.java:_empty_/VirtualFileSystem#
...
public class ImageSimilarityEngine implements DeduplicationEngine {
    ...
    @Override
    public String checkDuplicate(V@@irtualFileSystem vfs, String incomingPath) {
        return null;
    }
