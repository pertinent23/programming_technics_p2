error id: file://<WORKSPACE>/app/src/main/java/os_p2/engine/LegacyNativeEngine.java:_empty_/VirtualFileInfo#
file://<WORKSPACE>/app/src/main/java/os_p2/engine/LegacyNativeEngine.java
empty definition using pc, found symbol in pc: _empty_/VirtualFileInfo#
    ...
    public Stream<List<String>> scan(VirtualFileSystem vfs, String rootPath) {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            List<String> paths = vfs.listContent().stream()
                .map(VirtualFileIn@@fo::physicalPath)
