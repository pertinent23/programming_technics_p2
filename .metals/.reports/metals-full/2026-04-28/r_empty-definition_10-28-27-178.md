error id: file://<WORKSPACE>/app/src/main/java/os_p2/engine/ImageSimilarityEngine.java:java/util/function/IntUnaryOperator#
file://<WORKSPACE>/app/src/main/java/os_p2/engine/ImageSimilarityEngine.java
empty definition using pc, found symbol in pc: java/util/function/IntUnaryOperator#
...
public class ImageSimilarityEngine implements DeduplicationEngine {
    ...
    public Stream<List<String>> scan(VirtualFileSystem vfs, String rootPath) {
        ...
        java.util.function.IntUn@@aryOperator find = new java.util.function.IntUnaryOperator() {
            @Override
