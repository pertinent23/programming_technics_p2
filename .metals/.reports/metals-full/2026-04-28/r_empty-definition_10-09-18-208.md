error id: file://<WORKSPACE>/app/src/main/java/os_p2/engine/LegacyNativeEngine.java:_empty_/VirtualFileSystem#
...
public class LegacyNativeEngine implements DeduplicationEngine {
    ...
    @Override
    public Stream<List<String>> scan(V@@irtualFileSystem vfs, String rootPath) {
