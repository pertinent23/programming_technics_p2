error id: file://<WORKSPACE>/app/src/main/java/os_p2/engine/PureJavaHashEngine.java:_empty_/VirtualFileInfo#size#
file://<WORKSPACE>/app/src/main/java/os_p2/engine/PureJavaHashEngine.java
empty definition using pc, found symbol in pc: _empty_/VirtualFileInfo#size#
...
public class PureJavaHashEngine implements DeduplicationEngine {
    ...
    public String checkDuplicate(VirtualFileSystem vfs, String incomingPath) {
        ...
        for (VirtualFileInfo file : allFiles) {
            sizeGroups.computeIfAbsent(file.si@@ze(), k -> new ArrayList<>()).add(file);
        }
